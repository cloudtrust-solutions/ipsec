...
grep -Fq 'cloudtrust-solutions/ipsec' /etc/apparmor.d/local/usr.lib.ipsec.charon || echo "
...
grep -Fq 'cloudtrust-solutions/ipsec' /etc/ssh/sshd_config || echo "
# https://github.com/cloudtrust-solutions/ipsec
MaxStartups 1
MaxAuthTries 2
...
grep -Fq 'cloudtrust-solutions/ipsec' /etc/aliases || echo "
# https://github.com/cloudtrust-solutions/ipsec
root: ${EMAILADDR}
...
grep -Fq 'cloudtrust-solutions/ipsec' /etc/ipsec.conf || echo "
# https://github.com/cloudtrust-solutions/ipsec
conn ikev2vpn
        ikelifetime=60m
        keylife=20m
...
" >> /etc/ipsec.conf
grep -Fq 'cloudtrust-solutions/ipsec' /etc/ipsec.secrets || echo "
# https://github.com/cloudtrust-solutions/ipsec
\${VPNUSERNAME} : EAP \"\${VPNPASSWORD}\"
" >> /etc/ipsec.secrets
ipsec restart
